...
FLOWERS FOR HOPE - SUPPORT UKRAINE
...
For eight years, our nonprofit has worked with schools and communities in need of beautification, together we leverage the power of art from within.

**PARTHENIA ACADEMY**
Northridge, CA
5+ Murals with over 3 artists

**WEST ADAMS HIGHSCHOOL**
Los Angeles, CA
7+ Murals with over 6 artists
...
<!-- TODO widgets on original Wix page: Email Signup Form: email input field with submit button, label "Join Our Mailing List", success message "Thanks for submitting!"; Testimonial section with two attributed quotes (Kirsten Gillibrand, Pam O'Connor); testimonial images link to http://www.wix.com (placeholder links).; No embedded videos detected. Page built with Wix; Google Site Verification present; social meta tags for Facebook/Twitter. -->